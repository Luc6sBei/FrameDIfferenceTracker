...
save_path = 'image/DFM_'
plt.plot(time_array[1::], total_error_array[1::])
plt.xlabel('Time(s)')
plt.ylabel('Total error')
plt.title('Total error plot of the DFM method')
